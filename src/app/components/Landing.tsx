...
const Landing: React.FC = () => {
  ...
  return (
    <>
      ...
      {["pricing", "paymentMethods", "downloadForm", "contact"].map(
        (section, index) => (
          <motion.section
            key={index}
          ...
          >
            ...
            {section === "paymentMethods" && (
              <>
                ...
                <ul>
                  <li>
                    Zelle - Número de contacto:{" "}
                    <span className={styles.bold}>+1 3216828970</span> (Edgar Gonzalez)
                  </li>
            ...
            {section === "downloadForm" && (
              <>
                ...
                <p>
                  Descarga el formulario en PDF para completar tu solicitud.
                </p>
